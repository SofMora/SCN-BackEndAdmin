...
@EnableJpaRepositories(
        basePackages = "com.admin.scnadmin.repository.appointment",
...
public class AppointmentJpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
            @Qualifier("AppointmentsDataSource") DataSource sqlServerDS){
        ...
        localContainer.setPersistenceUnitName("SqlServerAppointment");
    ...
    public JpaTransactionManager transactionManager(@Qualifier("appointmentEntityManagerFactory") LocalContainerEntityManagerFactoryBean entityManagerFactory) {
