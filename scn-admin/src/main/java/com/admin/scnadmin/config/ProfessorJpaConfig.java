...
public class ProfessorJpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        localContainer.setPersistenceUnitName("SqlServerProfessor");
    ...
    public JpaTransactionManager transactionManager(@Qualifier("professorEntityManagerFactory") LocalContainerEntityManagerFactoryBean entityManagerFactory) {
